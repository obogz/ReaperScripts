...
- there are scripts already that operate on all notes under cursor (as in not only the held ones): inversion, delteion, adjust veolcity etc., these can be easilty integrated in the ReaperTon workflow
